...
- [Cosmos DB scenario-based labs - Retail hands-on lab step-by-step](#cosmos-db-scenario-based-labs---retail-hands-on-lab-step-by-step)
  ...
  - [Exercise 1: Configure Synapse Analytics and generate event data](#exercise-1-configure-Synapse-Analytics-and-generate-event-data)
    - [Task 1: Configure Azure Synapse Analytics](#task-1-configure-azure-Synapse-Analytics)
